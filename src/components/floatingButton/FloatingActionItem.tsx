...
import { StyleSheet, Text, Image, View, Animated, LogBox } from 'react-native';
...
interface Props {
  ...
  name: any;
  onPress: any;
  elevation: any; // eslint-disable-line
  text: any;
  position: any;
  textElevation: any;
  textBackground: any;
...
class FloatingActionItem extends Component<Props, State> {
  ...
  renderButton() {
    ...
    // console.log('vutton size', buttonSize)
    let iconStyle;
